...
# # set :use_sudo, false   # https://github.com/capistrano/capistrano/wiki/2.x-From-The-Beginning 
set :user, 'webmaster'   
set :use_sudo, false   # https://github.com/capistrano/capistrano/wiki/2.x-From-The-Beginning 

# roles - https://github.com/capistrano/capistrano/wiki/Roles
# capistrano ssh's to these addresses
role :web, '192.168.1.121'                          # Your HTTP server, Apache/etc
role :app, '192.168.1.121'                          # This may be the same as your `Web` server
role :db,  '192.168.1.121', :primary => true 		# This is where Rails migrations will run

# # role :web, 'nielsenfamily.ca'                          # Your HTTP server, Apache/etc
# # role :app, 'nielsenfamily.ca'                          # This may be the same as your `Web` server
# # # role :db,  'mysql.nielsenfamily.ca', :primary => true 		# This is where Rails migrations will run
# # role :db,  'nielsenfamily.ca', :primary => true 		# This is where Rails migrations will run
